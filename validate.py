...
def validate_structure():
    ...
    try:
        with open("custom_components/template_media_player/manifest.json") as f:
            ...
            if manifest.get("domain") != "template_media_player":
                errors.append(f"❌ Domain should be 'template_media_player', got: {manifest.get('domain')}")
    ...
    try:
        with open("custom_components/template_media_player/entity.py") as f:
            content = f.read()
            if "from homeassistant.components.template.entity import TemplateEntity" in content:
                print("✅ entity.py imports native TemplateEntity from Home Assistant core")
            else:
        ...
        with open("custom_components/template_media_player/media_player.py") as f:
            ...
            for component, description in required_components:
                if component in content:
                    ...
                    warnings.append(f"⚠️  media_player.py might be missing {description}")
